...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "Update_Course")) {
  ...
  $insertGoTo = "deny_delete_record.php?ID=" . $row_rs_courseInfo['ID'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_fiu_grading_system, $fiu_grading_system);
$query_rs_courseInfo = sprintf("SELECT * FROM CourseRequests WHERE ID = %s", GetSQLValueString($colname_rs_courseInfo, "int"));
...
<title>Admin Session: Check Course - FIU Online Grading</title>
<!-- Le styles -->
...
<legend><h1> Check Course Information </h1></legend>
...
<div class="control-group">
 ...
 <span class="textfieldInvalidFormatMsg">Invalid format. EXAMPLE: COP3232</span><span class="textfieldRequiredMsg">A value is required.</span></span></div>
</div>
...
<div class="control-group">
 ...
 <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format. Numeric values only.</span><span class="textfieldMaxCharsMsg">Exceeded maximum number of characters.</span><span class="textfieldMaxValueMsg">The entered value is greater than the maximum allowed.</span><span class="textfieldMinValueMsg">The entered value is less than the minimum required.</span></span></div>
</div>
<div class="controls">
  <p>
    <input type="submit" name="submit" id="submit" value="Submit" class="btn btn-primary"/> 
     <a href="Approve_Course.php"><button name="Cancel" type="button" id="cancel" class="btn btn-danger"> Cancel </button></a>
  </p> 
</div>
</div>
  <input name="ID" type="hidden" id="ID" value="<?php echo $row_rs_courseInfo['ID']; ?>"/>
  <input name="professor_ID" type="hidden" id="professor_ID" value="<?php echo $row_rs_courseInfo['professor_ID']; ?>"/>
  <input type="hidden" name="MM_insert" value="Update_Course" />
</form>
...
var sprytextfield2 = new Spry.Widget.ValidationTextField("sprytextfield2", "custom", {validateOn:["blur"], pattern:"A00"});
var sprytextfield3 = new Spry.Widget.ValidationTextField("sprytextfield3", "integer", {validateOn:["blur"], maxChars:11, maxValue:999, minValue:1});
</script>
</body>
</html>
<?php
