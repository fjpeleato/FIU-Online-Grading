...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "create_professor")) {
  ...
  $insertGoTo = "Student_Manage_Accounts.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Admin Session: Create Student - FIU Online Grading</title>
...
<legend><h1> Create a Student</h1></legend>
<br />
...
<div class="control-group">
 ...
 <div class="controls"><span id="sprytextfield3">
   <input name="user_name" type="text" id="user_name"  placeholder=" User Name" />
   <span class="textfieldRequiredMsg">A value is required.</span></span></div>
</div>
<div class="control-group">
 <label class="control-label" for="password_hash"> Password </label>
 <div class="controls"><span id="sprypassword1">
 <input name="password_hash" type="password" id="password_hash" placeholder="Create a password" />
